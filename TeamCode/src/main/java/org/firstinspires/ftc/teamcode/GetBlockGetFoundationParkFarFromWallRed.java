...
public class GetBlockGetFoundationParkFarFromWallRed extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        robot.mecanumStrafe(0.5, 20,MovementDirection.LEFT, 0); //x: -18 -36 y: -34 -34
        ...
        robot.mecanumStrafe(0.5, 10,MovementDirection.LEFT, -90); //58 40 y: -24 -24
        ...
        robot.turnRobot(0.4, -180); //turn 90 clockwise
        robot.mecanumDriveStraightAlongZero(-0.8,-25,-180); //x: 48 30 y: -49 -49
        foundation.releaseFoundation();
        robot.mecanumDriveStraightAlongZero(0.5,40,-180); //x: 48 30 y: -49 -49
        robot.mecanumStrafe(0.5, 10,MovementDirection.RIGHT, -180); //48 30 y: -24 -24
    }
}